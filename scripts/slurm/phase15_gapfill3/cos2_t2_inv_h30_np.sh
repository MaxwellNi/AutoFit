...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/cos2_t2_inv30_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/cos2_t2_inv30_%j.err
#SBATCH --export=ALL
...
"$INSIDER_PY" scripts/run_block3_benchmark_shard.py \
    ...
    --preset full --target-filter investors_count --horizons-filter 30 \
    --output-dir runs/benchmarks/block3_phase9_fair/task2_forecast/tslib_sota/core_only_seed2 --seed 42 \
