#!/bin/bash
#SBATCH --job-name=af739_t1_e2_bin
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/af739_t1_e2_bin_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/af739_t1_e2_bin_%j.err
#SBATCH --export=ALL
