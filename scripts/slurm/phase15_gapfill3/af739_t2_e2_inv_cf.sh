#!/bin/bash
#SBATCH --job-name=af739_t2_e2_inv
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/af739_t2_e2_inv_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/af739_t2_e2_inv_%j.err
#SBATCH --export=ALL
...
"$INSIDER_PY" scripts/run_block3_benchmark_shard.py \
    ...
    --output-dir runs/benchmarks/block3_phase9_fair/task2_forecast/autofit/core_edgar_seed2 --seed 42