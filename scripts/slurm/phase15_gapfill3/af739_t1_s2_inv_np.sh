#!/bin/bash
#SBATCH --job-name=af739_t1_s2_inv
#SBATCH --account=npin
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/af739_t1_s2_inv_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/af739_t1_s2_inv_%j.err
#SBATCH --export=ALL
