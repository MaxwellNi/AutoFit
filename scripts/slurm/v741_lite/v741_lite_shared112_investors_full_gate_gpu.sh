...
LABEL=v741_lite_shared112_investors_full_gate_20260406
...
"$INSIDER_PY" scripts/run_v740_shared112_champion_loop.py \
  ...
  --summary-md "docs/references/V741_LITE_SHARED112_INVESTORS_FULL_GATE_20260406.md" \
