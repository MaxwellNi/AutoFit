#!/bin/bash
#SBATCH --job-name=v740_112_bin_cf
...
"$INSIDER_PY" scripts/run_v740_shared112_champion_loop.py \
  ...
  --skip-existing \
  --output-dir "$RUN_ROOT/v740_shared112_binary_routed_guard_cfisch_20260404" \
  --summary-md "$RUN_ROOT/v740_shared112_binary_routed_guard_cfisch_20260404.md" \
