#!/bin/bash
#SBATCH --job-name=smm_cf_evtwave
...
LABEL=${LABEL:-mainline_investors_event_state_wave_cf_bigmem_20260415}
TASK=${TASK:-task2_forecast}
TARGET=${TARGET:-investors_count}
HORIZONS=${HORIZONS:-1,7,30}
ABLATIONS=${ABLATIONS:-core_only core_edgar core_text full}
