...
def main() -> None:
    ...
    core_sql_cols = list(dict.fromkeys(core_out_cols))
    extras_sql_cols = list(dict.fromkeys(extras_out_cols + ([DEDUP_COL] if DEDUP_COL in schema_names else [])))
    overrides: Dict[str, str] = {}
    ...
    # Choose sqlite DB location (avoid /tmp filling up)
