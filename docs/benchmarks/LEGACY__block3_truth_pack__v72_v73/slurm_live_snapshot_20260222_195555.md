...
|---|---|---|
| snapshot_ts | 2026-02-22T19:55:55.443649+00:00 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| running_total | 8 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| pending_total | 66 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| running_by_partition | {"batch": 8} | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| pending_by_partition | {"batch": 58, "gpu": 8} | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |

## Pending Reason Top-K

| reason | count | evidence_path |
|---|---|---|
| (QOSMaxJobsPerUserLimit) | 58 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
...
| p7x | squeue | {"PENDING": 32, "RUNNING": 7} | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
...
| p7x | sacct | {"COMPLETED": 82, "PENDING": 32, "RUNNING": 7} | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
