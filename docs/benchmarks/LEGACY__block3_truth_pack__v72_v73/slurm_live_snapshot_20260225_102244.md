...
|---|---|---|
| snapshot_ts | 2026-02-25T10:22:44.282349+00:00 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| running_total | 8 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| pending_total | 53 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| running_by_partition | {"batch": 8} | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| pending_by_partition | {"batch": 5, "bigmem": 40, "gpu": 8} | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |

## Pending Reason Top-K

| reason | count | evidence_path |
|---|---|---|
| (QOSGrpNodeLimit) | 48 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| (QOSMaxJobsPerUserLimit) | 5 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
