...
|---|---|---|
| snapshot_ts | 2026-02-26T15:18:55.800807+00:00 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| running_total | 1 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| pending_total | 18 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| running_by_partition | {"bigmem": 1} | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
| pending_by_partition | {"bigmem": 10, "gpu": 8} | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |

## Pending Reason Top-K

| reason | count | evidence_path |
|---|---|---|
| (QOSGrpNodeLimit) | 18 | docs/benchmarks/block3_truth_pack/slurm_snapshot.json |
