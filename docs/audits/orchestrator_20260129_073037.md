...
### Build offers_text_full (streaming, auto-tuned memory)

Chunk size is **auto-tuned from available RAM** (40% of MemAvailable minus 8GB headroom, ~800B/row). Cap 5M--50M rows/chunk. Override with `--chunk_rows N` if needed.
