...
|---|---:|---:|---|
| `SAMformer` | Yes | No package route verified | easy custom wrapper candidate |
...
| `TabPFN-TS` | Yes | repo exists; standalone route verified | high information-gain fast baseline |
| `Prophet` | Yes | Yes, pip package `prophet` | easiest missing sanity baseline |
