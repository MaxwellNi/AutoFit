...
2. The current physical Phase 9 result surface still reflects the seed-replication reinterpretation:
   ...
   - `core_edgar`
   - `core_edgar_seed2`
3. Text embedding artifacts now exist. Phase 12 text reruns have been submitted (40 jobs, 2026-03-15).
4. Once Phase 12 lands, `core_text` / `full` will reflect real text features.
