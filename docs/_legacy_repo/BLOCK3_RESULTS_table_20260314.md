...
> Current live status snapshot: `docs/benchmarks/phase9_current_snapshot.md`
> Interpretation note: current Phase 9 landed results still reflect the seed-replication reinterpretation until the real text-enabled reruns land.

**Generated**: 2026-03-13 18:40:49
**Benchmark Dir**: `block3_phase9_fair`
**Total Records (post-filter)**: 6672
...
| NegativeBinomialGLM | 1394.2 | 1029.1 | 1947.6 |
...
| task1_outcome | ml_tabular | core_text | 1 |
...
---
_Last updated: 2026-03-13 18:40:50_
