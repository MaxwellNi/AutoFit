...
Unified interface for all 73 models across 7 categories:
  ...
  - transformer_sota(20): PatchTST, iTransformer, TimesNet, TSMixer,
  ...
  - autofit         (12): V1, V2, V2E, V3, V3E, V3Max, V4, V5, V6, V7, V71, V72
"""
