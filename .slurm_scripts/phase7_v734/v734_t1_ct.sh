...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_v734/v734_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v734/v734_t1_ct_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task1_outcome | Ablation: core_text | Model: AutoFitV734"
echo "============================================================"
