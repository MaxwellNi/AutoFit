...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_v734/v734_t3_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v734/v734_t3_ct_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "============================================================"
echo "V7.3.4 Empirical Oracle Champion | Job ${SLURM_JOB_ID}"
echo "$(date -Iseconds) | $(hostname) | GPU: $(nvidia-smi --query-gpu=name --format=csv,noheader 2>/dev/null || echo N/A)"
echo "Task: task3_risk_adjust | Ablation: core_text | Model: AutoFitV734"
echo "============================================================"
