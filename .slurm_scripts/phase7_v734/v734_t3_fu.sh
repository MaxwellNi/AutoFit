...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_v734/v734_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v734/v734_t3_fu_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task3_risk_adjust | Ablation: full | Model: AutoFitV734"
echo "============================================================"
