#!/usr/bin/env bash
#SBATCH --job-name=cf_gf_ml_t2_ce
...
#SBATCH --output=/work/projects/eint/logs/phase13/cf_gf_ml_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase13/cf_gf_ml_t2_ce_%j.err
#SBATCH --export=ALL
