#!/usr/bin/env bash
#SBATCH --job-name=cf_gf_ml_t3_co
...
#SBATCH --output=/work/projects/eint/logs/phase13/cf_gf_ml_t3_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase13/cf_gf_ml_t3_co_%j.err
#SBATCH --export=ALL
