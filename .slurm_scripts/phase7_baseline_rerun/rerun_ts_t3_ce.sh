#!/usr/bin/env bash
#SBATCH --job-name=rerun_ts_t3_ce
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_baseline_rerun/rerun_ts_t3_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_baseline_rerun/rerun_ts_t3_ce_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
