...
#SBATCH --output=/work/projects/eint/logs/phase8/p8_fmTF_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8/p8_fmTF_t1_fu_%j.err
#SBATCH --export=ALL
