...
#SBATCH --output=/work/projects/eint/logs/phase8/p8_fmTF_t2_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8/p8_fmTF_t2_co_%j.err
#SBATCH --export=ALL
