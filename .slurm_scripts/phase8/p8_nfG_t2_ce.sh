...
#SBATCH --output=/work/projects/eint/logs/phase8/p8_nfG_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8/p8_nfG_t2_ce_%j.err
#SBATCH --export=ALL
