...
#SBATCH --output=/work/projects/eint/logs/phase8/p8_afG_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8/p8_afG_t1_co_%j.err
#SBATCH --export=ALL
...
echo "Output: runs/benchmarks/block3_20260203_225620_phase7/task1_outcome/autofit/core_only"
echo "============================================================"
