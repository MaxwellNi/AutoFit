...
#SBATCH --output=/work/projects/eint/logs/phase8/p8_dcB_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8/p8_dcB_t1_ct_%j.err
#SBATCH --export=ALL
...
echo "Output: runs/benchmarks/block3_20260203_225620_phase7/task1_outcome/deep_classical/core_text"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_text \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/task1_outcome/deep_classical/core_text \
    --seed 42 \
    --no-verify-first \
