...
#SBATCH --output=/work/projects/eint/logs/phase8/p8_dcB_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8/p8_dcB_t2_ce_%j.err
#SBATCH --export=ALL
...
echo "Output: runs/benchmarks/block3_20260203_225620_phase7/task2_forecast/deep_classical/core_edgar"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_edgar \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/task2_forecast/deep_classical/core_edgar \
    --seed 42 \
    --no-verify-first \
