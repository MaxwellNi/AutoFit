#!/usr/bin/env bash
#SBATCH --job-name=p11_tslib_new_t2_ct
#SBATCH --account=npin
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase11/p11_tslib_new_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase11/p11_tslib_new_t2_ct_%j.err
#SBATCH --export=ALL
