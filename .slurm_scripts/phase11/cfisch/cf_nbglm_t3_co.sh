#!/usr/bin/env bash
#SBATCH --job-name=cf_nbglm_t3_co
...
#SBATCH --output=/work/projects/eint/logs/phase11/cf_nbglm_t3_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase11/cf_nbglm_t3_co_%j.err
#SBATCH --export=ALL
...
echo "Task: task3_risk_adjust | Cat: ml_tabular | Abl: core_only | Models: NegativeBinomialGLM"
