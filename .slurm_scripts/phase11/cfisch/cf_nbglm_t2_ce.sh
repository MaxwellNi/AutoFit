#!/usr/bin/env bash
#SBATCH --job-name=cf_nbglm_t2_ce
...
#SBATCH --output=/work/projects/eint/logs/phase11/cf_nbglm_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase11/cf_nbglm_t2_ce_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Cat: ml_tabular | Abl: core_edgar | Models: NegativeBinomialGLM"
