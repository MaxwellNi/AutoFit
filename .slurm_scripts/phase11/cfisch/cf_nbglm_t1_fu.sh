#!/usr/bin/env bash
#SBATCH --job-name=cf_nbglm_t1_fu
...
#SBATCH --output=/work/projects/eint/logs/phase11/cf_nbglm_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase11/cf_nbglm_t1_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: ml_tabular | Abl: full | Models: NegativeBinomialGLM"
