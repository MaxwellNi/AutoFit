...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase11/cf_p11_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase11/cf_p11_t1_fu_%j.err
#SBATCH --export=ALL
