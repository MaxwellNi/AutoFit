#!/usr/bin/env bash
#SBATCH --job-name=cf_rerun_dc_t3_ce
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_cfisch/cf_rerun_dc_t3_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_cfisch/cf_rerun_dc_t3_ce_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py     --task task3_risk_adjust     --category deep_classical     --ablation core_edgar     --preset full     --output-dir runs/benchmarks/block3_20260203_225620_phase7/task3_risk_adjust/deep_classical/core_edgar     --seed 42     --no-verify-first     --enable-global-dedup &
