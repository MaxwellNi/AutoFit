#!/usr/bin/env bash
#SBATCH --job-name=cf_rerun_fn_t1_ce
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_cfisch/cf_rerun_fn_t1_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_cfisch/cf_rerun_fn_t1_ce_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py     --task task1_outcome     --category foundation     --ablation core_edgar     --preset full     --output-dir runs/benchmarks/block3_20260203_225620_phase7/task1_outcome/foundation/core_edgar     --seed 42     --no-verify-first     --enable-global-dedup &
