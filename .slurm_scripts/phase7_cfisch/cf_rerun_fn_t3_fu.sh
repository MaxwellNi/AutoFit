#!/usr/bin/env bash
#SBATCH --job-name=cf_rerun_fn_t3_fu
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_cfisch/cf_rerun_fn_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_cfisch/cf_rerun_fn_t3_fu_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py     --task task3_risk_adjust     --category foundation     --ablation full     --preset full     --output-dir runs/benchmarks/block3_20260203_225620_phase7/task3_risk_adjust/foundation/full     --seed 42     --no-verify-first     --enable-global-dedup &
