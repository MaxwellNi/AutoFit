...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_v733/v733_t1_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v733/v733_t1_ce_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task1_outcome | Ablation: core_edgar | Model: AutoFitV733"
echo "============================================================"
