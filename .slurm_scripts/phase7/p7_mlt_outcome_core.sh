#!/usr/bin/env bash
#SBATCH --job-name=p7_mlt_outcome_core
...
#SBATCH --output=/work/projects/eint/logs/phase7/p7_mlt_outcome_core_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7/p7_mlt_outcome_core_%j.err
#SBATCH --export=ALL
...
echo "Output: runs/benchmarks/block3_20260203_225620_phase7/task1_outcome/ml_tabular/core_edgar"
echo "============================================================"
