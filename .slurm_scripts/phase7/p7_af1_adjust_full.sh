#!/usr/bin/env bash
#SBATCH --job-name=p7_af1_adjust_full
...
#SBATCH --output=/work/projects/eint/logs/phase7/p7_af1_adjust_full_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7/p7_af1_adjust_full_%j.err
#SBATCH --export=ALL
