#!/usr/bin/env bash
#SBATCH --job-name=p7_af2_forecast_core
...
#SBATCH --output=/work/projects/eint/logs/phase7/p7_af2_forecast_core_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7/p7_af2_forecast_core_%j.err
#SBATCH --export=ALL
