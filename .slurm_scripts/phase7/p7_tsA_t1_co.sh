...
#SBATCH --output=/work/projects/eint/logs/phase7/p7_tsA_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7/p7_tsA_t1_co_%j.err
#SBATCH --export=ALL
