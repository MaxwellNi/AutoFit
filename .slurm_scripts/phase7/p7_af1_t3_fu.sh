...
#SBATCH --output=/work/projects/eint/logs/phase7/p7_af1_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7/p7_af1_t3_fu_%j.err
#SBATCH --export=ALL
