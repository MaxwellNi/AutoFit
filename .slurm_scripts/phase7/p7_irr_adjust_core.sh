#!/usr/bin/env bash
#SBATCH --job-name=p7_irr_adjust_core
...
#SBATCH --output=/work/projects/eint/logs/phase7/p7_irr_adjust_core_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7/p7_irr_adjust_core_%j.err
#SBATCH --export=ALL
...
echo "Output: runs/benchmarks/block3_20260203_225620_phase7/task3_risk_adjust/irregular/core_edgar"
echo "============================================================"
