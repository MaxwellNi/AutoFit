...
#SBATCH --output=/work/projects/eint/logs/phase7/p7_tsB_t3_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7/p7_tsB_t3_co_%j.err
#SBATCH --export=ALL
