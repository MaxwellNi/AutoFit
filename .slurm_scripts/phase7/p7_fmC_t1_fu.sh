...
#SBATCH --output=/work/projects/eint/logs/phase7/p7_fmC_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7/p7_fmC_t1_fu_%j.err
#SBATCH --export=ALL
