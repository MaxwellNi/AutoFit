...
#SBATCH --output=/work/projects/eint/logs/phase7/p7_fmH_t2_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7/p7_fmH_t2_fu_%j.err
#SBATCH --export=ALL
