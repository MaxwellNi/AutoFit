#!/usr/bin/env bash
#SBATCH --job-name=p12_foun_t1_ct
#SBATCH --account=npin
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase12/p12_foun_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/p12_foun_t1_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: foundation | Abl: core_text | Models: Chronos,Chronos2,ChronosBolt,LagLlama,MOMENT,Moirai,Moirai2,MoiraiLarge,Sundial,TTM,TimeMoE,Timer,TimesFM,TimesFM2"
