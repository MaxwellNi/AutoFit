#!/usr/bin/env bash
#SBATCH --job-name=p12_irre_t1_fu
#SBATCH --account=npin
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase12/p12_irre_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/p12_irre_t1_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: irregular | Abl: full | Models: BRITS,CSDI,GRU-D,SAITS"
