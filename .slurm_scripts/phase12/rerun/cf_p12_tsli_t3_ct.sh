#!/usr/bin/env bash
#SBATCH --job-name=cf_p12_tsli_t3_ct
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase12/cf_p12_tsli_t3_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/cf_p12_tsli_t3_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task3_risk_adjust | Cat: tslib_sota | Abl: core_text | Models: CATS,Crossformer,ETSformer,FITS,KANAD,LightTS,MSGNet,MambaSimple,MultiPatchFormer,PAttn,Pyraformer,Reformer,TimeFilter,WPMixer"
