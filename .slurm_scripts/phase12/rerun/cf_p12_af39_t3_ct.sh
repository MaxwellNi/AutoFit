#!/usr/bin/env bash
#SBATCH --job-name=cf_p12_af39_t3_ct
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase12/cf_p12_af39_t3_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/cf_p12_af39_t3_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task3_risk_adjust | Cat: autofit | Abl: core_text | Models: AutoFitV739"
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    --task task3_risk_adjust --category autofit --ablation core_text \
    --preset full --output-dir runs/benchmarks/block3_phase9_fair/task3_risk_adjust/autofit/core_text --seed 42 \
