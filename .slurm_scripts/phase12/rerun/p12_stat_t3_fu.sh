#!/usr/bin/env bash
#SBATCH --job-name=p12_stat_t3_fu
#SBATCH --account=npin
...
#SBATCH --output=/work/projects/eint/logs/phase12/p12_stat_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/p12_stat_t3_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task3_risk_adjust | Cat: statistical | Abl: full | Models: AutoARIMA,AutoCES,AutoETS,AutoTheta,CrostonClassic,CrostonOptimized,CrostonSBA,DynamicOptimizedTheta,HistoricAverage,Holt,HoltWinters,MSTL,Naive,SF_SeasonalNaive,WindowAverage"
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    --task task3_risk_adjust --category statistical --ablation full \
    --preset full --output-dir runs/benchmarks/block3_phase9_fair/task3_risk_adjust/statistical/full --seed 42 \
