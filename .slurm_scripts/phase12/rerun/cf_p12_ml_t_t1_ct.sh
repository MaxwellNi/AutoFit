#!/usr/bin/env bash
#SBATCH --job-name=cf_p12_ml_t_t1_ct
...
#SBATCH --output=/work/projects/eint/logs/phase12/cf_p12_ml_t_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/cf_p12_ml_t_t1_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: ml_tabular | Abl: core_text | Models: CatBoost,ExtraTrees,HistGradientBoosting,LightGBM,LightGBMTweedie,MeanPredictor,NegativeBinomialGLM,RandomForest,SeasonalNaive,XGBoost,XGBoostPoisson"
