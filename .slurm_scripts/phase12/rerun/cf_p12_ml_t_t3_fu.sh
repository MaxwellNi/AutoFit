#!/usr/bin/env bash
#SBATCH --job-name=cf_p12_ml_t_t3_fu
...
#SBATCH --output=/work/projects/eint/logs/phase12/cf_p12_ml_t_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/cf_p12_ml_t_t3_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task3_risk_adjust | Cat: ml_tabular | Abl: full | Models: CatBoost,ExtraTrees,HistGradientBoosting,LightGBM,LightGBMTweedie,MeanPredictor,NegativeBinomialGLM,RandomForest,SeasonalNaive,XGBoost,XGBoostPoisson"
