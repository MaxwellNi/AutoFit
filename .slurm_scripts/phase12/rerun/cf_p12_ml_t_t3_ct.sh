#!/usr/bin/env bash
#SBATCH --job-name=cf_p12_ml_t_t3_ct
...
#SBATCH --output=/work/projects/eint/logs/phase12/cf_p12_ml_t_t3_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/cf_p12_ml_t_t3_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task3_risk_adjust | Cat: ml_tabular | Abl: core_text | Models: CatBoost,ExtraTrees,HistGradientBoosting,LightGBM,LightGBMTweedie,MeanPredictor,NegativeBinomialGLM,RandomForest,SeasonalNaive,XGBoost,XGBoostPoisson"
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    --task task3_risk_adjust --category ml_tabular --ablation core_text \
    --preset full --output-dir runs/benchmarks/block3_phase9_fair/task3_risk_adjust/ml_tabular/core_text --seed 42 \
