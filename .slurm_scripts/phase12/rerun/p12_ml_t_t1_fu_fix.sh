#!/usr/bin/env bash
#SBATCH --job-name=p12_ml_t_t1_fu_fix
#SBATCH --account=def-cfisc10
#SBATCH --partition=bigmem
#SBATCH --qos=normal
#SBATCH --time=2-00:00:00
#SBATCH --mem=640G
#SBATCH --cpus-per-task=28
#SBATCH --output=/work/projects/eint/logs/phase12/p12_ml_t_t1_fu_fix_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/p12_ml_t_t1_fu_fix_%j.err
#SBATCH --export=ALL
...
echo "============================================================"
echo "Phase 12 Text Re-run (OOM FIX 640G) | Job ${SLURM_JOB_ID} on $(hostname)"
...
echo "Task: task1_outcome | Cat: ml_tabular | Abl: full | Models: CatBoost,ExtraTrees,HistGradientBoosting,LightGBM,LightGBMTweedie,MeanPredictor,NegativeBinomialGLM,RandomForest,SeasonalNaive,XGBoost,XGBoostPoisson"
