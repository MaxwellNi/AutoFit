#!/usr/bin/env bash
#SBATCH --job-name=p12_stat_t2_ct
#SBATCH --account=npin
...
#SBATCH --output=/work/projects/eint/logs/phase12/p12_stat_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/p12_stat_t2_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Cat: statistical | Abl: core_text | Models: AutoARIMA,AutoCES,AutoETS,AutoTheta,CrostonClassic,CrostonOptimized,CrostonSBA,DynamicOptimizedTheta,HistoricAverage,Holt,HoltWinters,MSTL,Naive,SF_SeasonalNaive,WindowAverage"
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    --task task2_forecast --category statistical --ablation core_text \
    --preset full --output-dir runs/benchmarks/block3_phase9_fair/task2_forecast/statistical/core_text --seed 42 \
