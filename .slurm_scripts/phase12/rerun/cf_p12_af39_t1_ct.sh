#!/usr/bin/env bash
#SBATCH --job-name=cf_p12_af39_t1_ct
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase12/cf_p12_af39_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/cf_p12_af39_t1_ct_%j.err
#SBATCH --export=ALL
