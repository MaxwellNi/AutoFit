#!/usr/bin/env bash
#SBATCH --job-name=cf_v739_l40s_t1_co
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase12/cf_v739_l40s_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase12/cf_v739_l40s_t1_co_%j.err
#SBATCH --export=ALL
