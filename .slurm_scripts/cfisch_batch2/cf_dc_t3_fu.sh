...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/cfisch_batch2/cf_dc_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/cfisch_batch2/cf_dc_t3_fu_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "=== cf_dc_t3_fu | Job $SLURM_JOB_ID | $(date -Iseconds) ==="
