...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/cfisch_batch2/cf_fn_t1_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/cfisch_batch2/cf_fn_t1_ce_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "=== cf_fn_t1_ce | Job $SLURM_JOB_ID | $(date -Iseconds) ==="
