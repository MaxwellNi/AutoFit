...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/cfisch_batch2/cf_v735_t2_co_%j.out
#SBATCH --error=/work/projects/eint/logs/cfisch_batch2/cf_v735_t2_co_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "=== cf_v735_t2_co | Job $SLURM_JOB_ID | $(date -Iseconds) ==="
