#!/usr/bin/env bash
#SBATCH --job-name=p7v72b4_t3_co_fru_h7
...
#SBATCH --output=/work/projects/eint/logs/v72_batch_bypass_v72b4_20260225_112044/p7v72b4_t3_co_fru_h7_%j.out
#SBATCH --error=/work/projects/eint/logs/v72_batch_bypass_v72b4_20260225_112044/p7v72b4_t3_co_fru_h7_%j.err
#SBATCH --export=ALL
...
echo "Task=task3_risk_adjust Ablation=core_only Target=funding_raised_usd Horizon=7"
