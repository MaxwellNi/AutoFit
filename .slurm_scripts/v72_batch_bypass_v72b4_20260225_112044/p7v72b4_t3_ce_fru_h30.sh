#!/usr/bin/env bash
#SBATCH --job-name=p7v72b4_t3_ce_fru_h30
...
#SBATCH --output=/work/projects/eint/logs/v72_batch_bypass_v72b4_20260225_112044/p7v72b4_t3_ce_fru_h30_%j.out
#SBATCH --error=/work/projects/eint/logs/v72_batch_bypass_v72b4_20260225_112044/p7v72b4_t3_ce_fru_h30_%j.err
#SBATCH --export=ALL
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py   --task task3_risk_adjust   --category autofit   --ablation core_edgar   --models AutoFitV72   --target-filter funding_raised_usd   --horizons-filter 30   --preset full   --output-dir runs/benchmarks/block3_20260203_225620_phase7_v72_batch_bypass_v72b4_20260225_112044/task3_risk_adjust/autofit/core_edgar/funding_raised_usd/h30   --seed 42   --no-verify-first   --enable-global-dedup   --global-dedup-bench-glob block3_20260203_225620*
