...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_tslib_sota/hp_segrnn_c09_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_tslib_sota/hp_segrnn_c09_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"SegRNN\": {\"batch_size\": 32, \"d_ff\": 128, \"d_model\": 256, \"dropout\": 0.2, \"e_layers\": 3, \"learning_rate\":"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/tslib_sota/SegRNN/config_09 \
    --seed 42 \
    --no-verify-first \
    --models SegRNN \
    --model-kwargs-json '{"SegRNN": {"batch_size": 32, "d_ff": 128, "d_model": 256, "dropout": 0.2, "e_layers": 3, "learning_rate": 0.001, "max_epochs": 50}}' &
