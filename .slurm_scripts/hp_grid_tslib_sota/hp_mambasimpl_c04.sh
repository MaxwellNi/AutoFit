#!/usr/bin/env bash
#SBATCH --job-name=hp_mambasimpl_c04
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_tslib_sota/hp_mambasimpl_c04_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_tslib_sota/hp_mambasimpl_c04_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"MambaSimple\": {\"batch_size\": 64, \"d_ff\": 128, \"d_model\": 64, \"dropout\": 0.05, \"e_layers\": 4, \"learning_ra"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/tslib_sota/MambaSimple/config_04 \
    --seed 42 \
    --no-verify-first \
    --models MambaSimple \
    --model-kwargs-json '{"MambaSimple": {"batch_size": 64, "d_ff": 128, "d_model": 64, "dropout": 0.05, "e_layers": 4, "learning_rate": 0.001, "max_epochs": 50}}' &
