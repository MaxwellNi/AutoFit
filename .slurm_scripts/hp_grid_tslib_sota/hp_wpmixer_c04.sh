#!/usr/bin/env bash
#SBATCH --job-name=hp_wpmixer_c04
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_tslib_sota/hp_wpmixer_c04_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_tslib_sota/hp_wpmixer_c04_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"WPMixer\": {\"batch_size\": 32, \"d_ff\": 512, \"d_model\": 128, \"dropout\": 0.2, \"e_layers\": 2, \"learning_rate\""
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/tslib_sota/WPMixer/config_04 \
    --seed 42 \
    --no-verify-first \
    --models WPMixer \
    --model-kwargs-json '{"WPMixer": {"batch_size": 32, "d_ff": 512, "d_model": 128, "dropout": 0.2, "e_layers": 2, "learning_rate": 0.002, "max_epochs": 50, "n_heads": 8}}' &
