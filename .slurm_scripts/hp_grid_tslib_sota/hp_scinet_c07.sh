...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_tslib_sota/hp_scinet_c07_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_tslib_sota/hp_scinet_c07_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"SCINet\": {\"batch_size\": 32, \"d_ff\": 256, \"d_model\": 64, \"dropout\": 0.2, \"e_layers\": 3, \"learning_rate\": "
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/tslib_sota/SCINet/config_07 \
    --seed 42 \
    --no-verify-first \
    --models SCINet \
    --model-kwargs-json '{"SCINet": {"batch_size": 32, "d_ff": 256, "d_model": 64, "dropout": 0.2, "e_layers": 3, "learning_rate": 0.002, "max_epochs": 50}}' &
