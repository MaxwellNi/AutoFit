#!/usr/bin/env bash
#SBATCH --job-name=hp_mambasimpl_c05
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_tslib_sota/hp_mambasimpl_c05_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_tslib_sota/hp_mambasimpl_c05_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"MambaSimple\": {\"batch_size\": 32, \"d_ff\": 512, \"d_model\": 256, \"dropout\": 0.1, \"e_layers\": 3, \"learning_ra"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/tslib_sota/MambaSimple/config_05 \
    --seed 42 \
    --no-verify-first \
    --models MambaSimple \
    --model-kwargs-json '{"MambaSimple": {"batch_size": 32, "d_ff": 512, "d_model": 256, "dropout": 0.1, "e_layers": 3, "learning_rate": 0.0005, "max_epochs": 50}}' &
