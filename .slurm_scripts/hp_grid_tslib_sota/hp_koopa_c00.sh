...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_tslib_sota/hp_koopa_c00_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_tslib_sota/hp_koopa_c00_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"Koopa\": {\"batch_size\": 128, \"d_ff\": 128, \"d_model\": 64, \"dropout\": 0.05, \"e_layers\": 3, \"learning_rate\":"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/tslib_sota/Koopa/config_00 \
    --seed 42 \
    --no-verify-first \
    --models Koopa \
    --model-kwargs-json '{"Koopa": {"batch_size": 128, "d_ff": 128, "d_model": 64, "dropout": 0.05, "e_layers": 3, "learning_rate": 0.0005, "max_epochs": 50}}' &
