...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_tslib_sota/hp_film_c06_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_tslib_sota/hp_film_c06_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"FiLM\": {\"batch_size\": 32, \"d_ff\": 512, \"d_model\": 64, \"dropout\": 0.1, \"e_layers\": 2, \"learning_rate\": 0."
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/tslib_sota/FiLM/config_06 \
    --seed 42 \
    --no-verify-first \
    --models FiLM \
    --model-kwargs-json '{"FiLM": {"batch_size": 32, "d_ff": 512, "d_model": 64, "dropout": 0.1, "e_layers": 2, "learning_rate": 0.0005, "max_epochs": 50}}' &
