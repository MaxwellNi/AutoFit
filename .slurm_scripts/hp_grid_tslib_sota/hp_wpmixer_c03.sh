#!/usr/bin/env bash
#SBATCH --job-name=hp_wpmixer_c03
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_tslib_sota/hp_wpmixer_c03_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_tslib_sota/hp_wpmixer_c03_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/tslib_sota/WPMixer/config_03 \
    --seed 42 \
    --no-verify-first \
    --models WPMixer \
    --model-kwargs-json '{"WPMixer": {"batch_size": 128, "d_ff": 256, "d_model": 64, "dropout": 0.05, "e_layers": 2, "learning_rate": 0.001, "max_epochs": 50, "n_heads": 8}}' &
