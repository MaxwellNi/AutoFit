#!/usr/bin/env bash
#SBATCH --job-name=p7v72b6_t3_co_ic_h30
...
#SBATCH --output=/work/projects/eint/logs/v72b6_20260225_132028/p7v72b6_t3_co_ic_h30_%j.out
#SBATCH --error=/work/projects/eint/logs/v72b6_20260225_132028/p7v72b6_t3_co_ic_h30_%j.err
#SBATCH --export=ALL
set -euo pipefail
