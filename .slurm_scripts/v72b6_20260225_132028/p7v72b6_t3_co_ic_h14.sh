#!/usr/bin/env bash
#SBATCH --job-name=p7v72b6_t3_co_ic_h14
...
#SBATCH --output=/work/projects/eint/logs/v72b6_20260225_132028/p7v72b6_t3_co_ic_h14_%j.out
#SBATCH --error=/work/projects/eint/logs/v72b6_20260225_132028/p7v72b6_t3_co_ic_h14_%j.err
#SBATCH --export=ALL
set -euo pipefail
