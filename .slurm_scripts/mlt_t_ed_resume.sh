...
#SBATCH --output=runs/benchmarks/block3_20260203_225620_iris_full/task3_risk_adjust/ml_tabular/core_edgar/slurm_%j.log
#SBATCH --error=runs/benchmarks/block3_20260203_225620_iris_full/task3_risk_adjust/ml_tabular/core_edgar/slurm_%j.err
#SBATCH --export=ALL
...
python3 scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_edgar \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_iris_full/task3_risk_adjust/ml_tabular/core_edgar \
    --seed 42 \
    --no-verify-first
