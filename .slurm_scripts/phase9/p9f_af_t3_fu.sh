#!/usr/bin/env bash
#SBATCH --job-name=p9f_af_t3_fu
#SBATCH --partition=bigmem
#SBATCH --qos=normal
#SBATCH --time=2-00:00:00
#SBATCH --mem=640G
#SBATCH --cpus-per-task=28
#SBATCH --output=/home/users/npin/repo_root/slurm_logs/phase9/p9f_af_t3_fu_%j.out
#SBATCH --error=/home/users/npin/repo_root/slurm_logs/phase9/p9f_af_t3_fu_%j.err
#SBATCH --export=ALL
...
echo ">>> V735: task3_risk_adjust | full | $(date -Iseconds)"
...
echo ">>> V734: task3_risk_adjust | full | $(date -Iseconds)"
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    --task task3_risk_adjust --category autofit --ablation full \
    --preset full --output-dir runs/benchmarks/block3_phase9_fair/task3_risk_adjust/autofit/full --seed 42 \
...
echo ">>> V736: task3_risk_adjust | full | $(date -Iseconds)"
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    --task task3_risk_adjust --category autofit --ablation full \
    --preset full --output-dir runs/benchmarks/block3_phase9_fair/task3_risk_adjust/autofit/full --seed 42 \
