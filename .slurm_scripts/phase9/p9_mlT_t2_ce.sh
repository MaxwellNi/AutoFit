...
#SBATCH --output=/work/projects/eint/logs/phase9/p9_mlT_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9_mlT_t2_ce_%j.err
#SBATCH --export=ALL
