...
#SBATCH --output=/work/projects/eint/logs/phase9/p9r_mlT_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9r_mlT_t2_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Cat: ml_tabular | Abl: core_text | Models: LightGBM,XGBoost,CatBoost,RandomForest,ExtraTrees,HistGradientBoosting,Ridge,Lasso,ElasticNet,SVR,KNN,QuantileRegressor,MeanPredictor,SeasonalNaive,LightGBMTweedie,XGBoostPoisson,LogisticRegression,NegativeBinomialGLM"
