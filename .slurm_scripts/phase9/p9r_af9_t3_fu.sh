...
#SBATCH --output=/work/projects/eint/logs/phase9/p9r_af9_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9r_af9_t3_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task3_risk_adjust | Cat: autofit | Abl: full | Models: AutoFitV736"
