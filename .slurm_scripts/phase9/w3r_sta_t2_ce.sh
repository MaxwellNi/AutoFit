...
#SBATCH --output=/work/projects/eint/logs/phase9/w3r_sta_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/w3r_sta_t2_ce_%j.err
#SBATCH --export=ALL
