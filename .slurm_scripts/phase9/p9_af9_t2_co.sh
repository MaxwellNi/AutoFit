...
#SBATCH --output=/work/projects/eint/logs/phase9/p9_af9_t2_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9_af9_t2_co_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Cat: autofit | Abl: core_only | Models: AutoFitV736"
