#!/usr/bin/env bash
#SBATCH --job-name=p9r2_mlT_t1_ce_isfunded
#SBATCH --account=npin
...
#SBATCH --output=/work/projects/eint/logs/phase9/p9r2_mlT_t1_ce_isfunded_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9r2_mlT_t1_ce_isfunded_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: ml_tabular | Abl: core_edgar | Target: is_funded"
