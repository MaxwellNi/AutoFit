...
#SBATCH --output=/work/projects/eint/logs/phase9/p9r_mlT_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9r_mlT_t1_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: ml_tabular | Abl: full | Models: LightGBM,XGBoost,CatBoost,RandomForest,ExtraTrees,HistGradientBoosting,Ridge,Lasso,ElasticNet,SVR,KNN,QuantileRegressor,MeanPredictor,SeasonalNaive,LightGBMTweedie,XGBoostPoisson,LogisticRegression,NegativeBinomialGLM"
