...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase9/p9_tsA_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9_tsA_t1_ct_%j.err
#SBATCH --export=ALL
