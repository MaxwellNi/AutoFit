...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase9/p9n_tpf_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9n_tpf_t2_ce_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Cat: ml_tabular | Abl: core_edgar | Models: TabPFNClassifier,TabPFNRegressor"
