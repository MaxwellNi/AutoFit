...
#SBATCH --output=/work/projects/eint/logs/phase9/w3r_af9_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/w3r_af9_t3_fu_%j.err
#SBATCH --export=ALL
