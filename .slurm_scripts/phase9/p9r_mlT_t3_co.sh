...
#SBATCH --output=/work/projects/eint/logs/phase9/p9r_mlT_t3_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9r_mlT_t3_co_%j.err
#SBATCH --export=ALL
