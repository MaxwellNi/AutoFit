...
#SBATCH --output=/work/projects/eint/logs/phase9/p9n_sta_t1_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9n_sta_t1_ce_%j.err
#SBATCH --export=ALL
