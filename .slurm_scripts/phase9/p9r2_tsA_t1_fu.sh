#!/usr/bin/env bash
#SBATCH --job-name=p9r2_tsA_t1_fu
#SBATCH --account=npin
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase9/p9r2_tsA_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9r2_tsA_t1_fu_%j.err
#SBATCH --export=ALL
