...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase9/cf_p9r3_fm_t2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/cf_p9r3_fm_t2_%j.err
#SBATCH --export=ALL
