#!/usr/bin/env bash
#SBATCH --job-name=cf_p9r2_tsC_t1_fu
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase9/p9r2_tsC_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9r2_tsC_t1_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: tslib_sota | Abl: full | Models: ETSformer,LightTS,Mamba,Pyraformer,Reformer,TiRex"
