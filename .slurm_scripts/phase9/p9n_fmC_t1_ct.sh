...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase9/p9n_fmC_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9n_fmC_t1_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: foundation | Abl: core_text | Models: Chronos2,TTM,TimerXL"
