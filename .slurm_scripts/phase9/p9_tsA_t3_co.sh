...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase9/p9_tsA_t3_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9_tsA_t3_co_%j.err
#SBATCH --export=ALL
