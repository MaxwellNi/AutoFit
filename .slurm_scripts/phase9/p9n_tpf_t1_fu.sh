...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase9/p9n_tpf_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9n_tpf_t1_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: ml_tabular | Abl: full | Models: TabPFNClassifier,TabPFNRegressor"
