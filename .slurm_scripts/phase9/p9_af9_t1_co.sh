...
#SBATCH --output=/work/projects/eint/logs/phase9/p9_af9_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9_af9_t1_co_%j.err
#SBATCH --export=ALL
