...
#SBATCH --output=/work/projects/eint/logs/phase9/p9r_af9_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9r_af9_t1_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: autofit | Abl: core_text | Models: AutoFitV736"
