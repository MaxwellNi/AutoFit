#!/usr/bin/env bash
#SBATCH --job-name=p9f_af_t1_co
#SBATCH --partition=bigmem
#SBATCH --qos=normal
#SBATCH --time=2-00:00:00
#SBATCH --mem=256G
#SBATCH --cpus-per-task=28
#SBATCH --output=/home/users/npin/repo_root/slurm_logs/phase9/p9f_af_t1_co_%j.out
#SBATCH --error=/home/users/npin/repo_root/slurm_logs/phase9/p9f_af_t1_co_%j.err
#SBATCH --export=ALL
...
echo ">>> V735: task1_outcome | core_only | $(date -Iseconds)"
...
echo ">>> V734: task1_outcome | core_only | $(date -Iseconds)"
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    --task task1_outcome --category autofit --ablation core_only \
    --preset full --output-dir runs/benchmarks/block3_phase9_fair/task1_outcome/autofit/core_only --seed 42 \
...
echo ">>> V736: task1_outcome | core_only | $(date -Iseconds)"
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    --task task1_outcome --category autofit --ablation core_only \
    --preset full --output-dir runs/benchmarks/block3_phase9_fair/task1_outcome/autofit/core_only --seed 42 \
