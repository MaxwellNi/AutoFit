...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase9/p9n_tpf_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9n_tpf_t2_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Cat: ml_tabular | Abl: core_text | Models: TabPFNClassifier,TabPFNRegressor"
