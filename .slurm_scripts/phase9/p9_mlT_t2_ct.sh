...
#SBATCH --output=/work/projects/eint/logs/phase9/p9_mlT_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase9/p9_mlT_t2_ct_%j.err
#SBATCH --export=ALL
