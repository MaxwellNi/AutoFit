#!/usr/bin/env bash
#SBATCH --job-name=p7v72k_t3_co_ic_h30
...
#SBATCH --output=/work/projects/eint/logs/v72_completion_20260226_172213/p7v72k_t3_co_ic_h30_%j.out
#SBATCH --error=/work/projects/eint/logs/v72_completion_20260226_172213/p7v72k_t3_co_ic_h30_%j.err
#SBATCH --export=ALL
...
echo "Task=task3_risk_adjust Ablation=core_only Target=investors_count Horizon=30"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
  ...
  --horizons-filter 30 \
  --preset full \
  --output-dir runs/benchmarks/block3_20260203_225620_phase7_v72_completion/task3_risk_adjust/autofit/core_only/investors_count/h30 \
  --seed 42 \
  --no-verify-first \
  --enable-global-dedup \
