#!/usr/bin/env bash
#SBATCH --job-name=hp_lightgbm_c10
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_ml_tabular/hp_lightgbm_c10_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_ml_tabular/hp_lightgbm_c10_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/ml_tabular/LightGBM/config_10 \
    --seed 42 \
    --no-verify-first \
    --models LightGBM \
    --model-kwargs-json '{"LightGBM": {"colsample_bytree": 0.7, "learning_rate": 0.01, "max_depth": 8, "min_child_samples": 10, "n_estimators": 100, "num_leaves": 31, "reg_alpha": 0.0, "reg_lambda": 1.0, "subsample": 1.0}}' &
