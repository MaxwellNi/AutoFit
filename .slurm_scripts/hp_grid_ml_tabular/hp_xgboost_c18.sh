#!/usr/bin/env bash
#SBATCH --job-name=hp_xgboost_c18
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_ml_tabular/hp_xgboost_c18_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_ml_tabular/hp_xgboost_c18_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/ml_tabular/XGBoost/config_18 \
    --seed 42 \
    --no-verify-first \
    --models XGBoost \
    --model-kwargs-json '{"XGBoost": {"colsample_bytree": 0.7, "learning_rate": 0.01, "max_depth": 6, "min_child_weight": 1, "n_estimators": 1000, "reg_alpha": 0.0, "reg_lambda": 0.0, "subsample": 1.0}}' &
