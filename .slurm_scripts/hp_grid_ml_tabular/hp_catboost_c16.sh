#!/usr/bin/env bash
#SBATCH --job-name=hp_catboost_c16
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_ml_tabular/hp_catboost_c16_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_ml_tabular/hp_catboost_c16_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"CatBoost\": {\"bagging_temperature\": 0, \"depth\": 4, \"iterations\": 1000, \"l2_leaf_reg\": 3, \"learning_rate\": 0"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/ml_tabular/CatBoost/config_16 \
    --seed 42 \
    --no-verify-first \
    --models CatBoost \
    --model-kwargs-json '{"CatBoost": {"bagging_temperature": 0, "depth": 4, "iterations": 1000, "l2_leaf_reg": 3, "learning_rate": 0.01}}' &
