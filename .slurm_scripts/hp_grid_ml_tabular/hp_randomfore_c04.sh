#!/usr/bin/env bash
#SBATCH --job-name=hp_randomfore_c04
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_ml_tabular/hp_randomfore_c04_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_ml_tabular/hp_randomfore_c04_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"RandomForest\": {\"max_depth\": 20, \"max_features\": \"log2\", \"min_samples_leaf\": 1, \"min_samples_split\": 10, \"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/ml_tabular/RandomForest/config_04 \
    --seed 42 \
    --no-verify-first \
    --models RandomForest \
    --model-kwargs-json '{"RandomForest": {"max_depth": 20, "max_features": "log2", "min_samples_leaf": 1, "min_samples_split": 10, "n_estimators": 100}}' &
