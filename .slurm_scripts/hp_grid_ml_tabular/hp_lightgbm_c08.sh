#!/usr/bin/env bash
#SBATCH --job-name=hp_lightgbm_c08
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_ml_tabular/hp_lightgbm_c08_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_ml_tabular/hp_lightgbm_c08_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"LightGBM\": {\"colsample_bytree\": 1.0, \"learning_rate\": 0.05, \"max_depth\": 4, \"min_child_samples\": 20, \"n_est"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/ml_tabular/LightGBM/config_08 \
    --seed 42 \
    --no-verify-first \
    --models LightGBM \
    --model-kwargs-json '{"LightGBM": {"colsample_bytree": 1.0, "learning_rate": 0.05, "max_depth": 4, "min_child_samples": 20, "n_estimators": 500, "num_leaves": 63, "reg_alpha": 0.0, "reg_lambda": 0.1, "subsample": 0.7}}' &
