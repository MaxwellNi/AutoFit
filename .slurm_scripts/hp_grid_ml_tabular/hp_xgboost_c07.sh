#!/usr/bin/env bash
#SBATCH --job-name=hp_xgboost_c07
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_ml_tabular/hp_xgboost_c07_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_ml_tabular/hp_xgboost_c07_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"XGBoost\": {\"colsample_bytree\": 0.7, \"learning_rate\": 0.05, \"max_depth\": 6, \"min_child_weight\": 3, \"n_estima"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/ml_tabular/XGBoost/config_07 \
    --seed 42 \
    --no-verify-first \
    --models XGBoost \
    --model-kwargs-json '{"XGBoost": {"colsample_bytree": 0.7, "learning_rate": 0.05, "max_depth": 6, "min_child_weight": 3, "n_estimators": 100, "reg_alpha": 1.0, "reg_lambda": 0.0, "subsample": 0.7}}' &
