#!/usr/bin/env bash
#SBATCH --job-name=cf_gf_ts_t2_co
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase14/cf_gf_ts_t2_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase14/cf_gf_ts_t2_co_%j.err
#SBATCH --export=ALL
