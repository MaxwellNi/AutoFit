#!/usr/bin/env bash
#SBATCH --job-name=cf_gf_ts_t1_ces2
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase14/cf_gf_ts_t1_ces2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase14/cf_gf_ts_t1_ces2_%j.err
#SBATCH --export=ALL
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --preset full --output-dir runs/benchmarks/block3_phase9_fair/task1_outcome/tslib_sota/core_edgar_seed2 --seed 42 \
