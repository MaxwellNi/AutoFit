...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase14/gf_ts_t3_cos2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase14/gf_ts_t3_cos2_%j.err
#SBATCH --export=ALL
