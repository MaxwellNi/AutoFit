#!/usr/bin/env bash
#SBATCH --job-name=cf_gf_fm_t2_ces2
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase14/cf_gf_fm_t2_ces2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase14/cf_gf_fm_t2_ces2_%j.err
#SBATCH --export=ALL
