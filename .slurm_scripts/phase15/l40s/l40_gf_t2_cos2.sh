#!/usr/bin/env bash
#SBATCH --job-name=l40_gf_t2_cos2
#SBATCH --account=npin
...
#SBATCH --output=/work/projects/eint/logs/phase15/gf_t2_cos2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/gf_t2_cos2_%j.err
#SBATCH --export=ALL
