#!/usr/bin/env bash
#SBATCH --job-name=l40_p15_t1_cos2
#SBATCH --account=npin
...
#SBATCH --output=/work/projects/eint/logs/phase15/p15_t1_cos2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/p15_t1_cos2_%j.err
#SBATCH --export=ALL
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    --task task1_outcome --category tslib_sota --ablation core_only_seed2 \
