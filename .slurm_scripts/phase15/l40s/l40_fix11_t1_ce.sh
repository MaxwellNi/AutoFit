#!/usr/bin/env bash
#SBATCH --job-name=l40_fix11_t1_ce
#SBATCH --account=npin
...
#SBATCH --output=/work/projects/eint/logs/phase15/l40_fix11_t1_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/l40_fix11_t1_ce_%j.err
#SBATCH --export=ALL
