...
#SBATCH --output=/work/projects/eint/logs/phase15/l40_gf_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/l40_gf_t1_co_%j.err
#SBATCH --export=ALL
