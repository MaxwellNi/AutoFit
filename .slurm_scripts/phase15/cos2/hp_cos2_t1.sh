...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/hp_cos2_t1_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/hp_cos2_t1_%j.err
#SBATCH --export=ALL
