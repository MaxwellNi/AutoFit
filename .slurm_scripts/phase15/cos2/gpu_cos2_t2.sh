...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/gpu_cos2_t2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/gpu_cos2_t2_%j.err
#SBATCH --export=ALL
