...
#SBATCH --output=/work/projects/eint/logs/phase15/hpcf_ac_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/hpcf_ac_t2_ct_%j.err
#SBATCH --export=ALL
