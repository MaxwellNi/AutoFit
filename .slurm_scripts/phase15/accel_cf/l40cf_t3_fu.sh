#!/bin/bash
#SBATCH --job-name=l40cf_ac_t3_fu
...
#SBATCH --output=/work/projects/eint/logs/phase15/l40cf_ac_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/l40cf_ac_t3_fu_%j.err
#SBATCH --export=ALL
