#!/bin/bash
#SBATCH --job-name=l40cf_ac_t1_ct
...
#SBATCH --output=/work/projects/eint/logs/phase15/l40cf_ac_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/l40cf_ac_t1_ct_%j.err
#SBATCH --export=ALL
