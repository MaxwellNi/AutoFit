...
#SBATCH --output=/work/projects/eint/logs/phase15/hpcf_ac_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/hpcf_ac_t1_fu_%j.err
#SBATCH --export=ALL
