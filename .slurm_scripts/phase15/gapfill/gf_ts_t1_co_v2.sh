#!/usr/bin/env bash
#SBATCH --job-name=gf_ts_t1_co_v2
#SBATCH --account=npin
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/gf_ts_t1_co_v2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/gf_ts_t1_co_v2_%j.err
#SBATCH --export=ALL
...
echo "GapFill Rerun | Job ${SLURM_JOB_ID} on $(hostname) | gpu/normal | $(date -Iseconds)"
