...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/p15_fix_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/p15_fix_t1_co_%j.err
#SBATCH --export=ALL
...
# Only rerun models that errored on old code
