#!/usr/bin/env bash
#SBATCH --job-name=l40cf_p15_t1_ces2
...
#SBATCH --output=/work/projects/eint/logs/phase15/cf_p15_t1_ces2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/cf_p15_t1_ces2_%j.err
#SBATCH --export=ALL
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    --task task1_outcome --category tslib_sota --ablation core_edgar_seed2 \
