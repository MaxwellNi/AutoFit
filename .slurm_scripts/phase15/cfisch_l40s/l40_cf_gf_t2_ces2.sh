#!/usr/bin/env bash
#SBATCH --job-name=l40cf_gf_t2_ces2
...
#SBATCH --output=/work/projects/eint/logs/phase15/cf_gf_t2_ces2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/cf_gf_t2_ces2_%j.err
#SBATCH --export=ALL
