...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/ml_t1_fu_fix2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/ml_t1_fu_fix2_%j.err
#SBATCH --export=ALL
...
echo "ML t1_fu fix2 | Job $SLURM_JOB_ID on $(hostname)"
