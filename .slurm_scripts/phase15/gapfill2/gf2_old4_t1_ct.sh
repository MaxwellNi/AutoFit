#!/bin/bash
#SBATCH --job-name=gf2_old4_t1_ct
#SBATCH --account=npin
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/gf2_old4_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/gf2_old4_t1_ct_%j.err
#SBATCH --export=ALL
