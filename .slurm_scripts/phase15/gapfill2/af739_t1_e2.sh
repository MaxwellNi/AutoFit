...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/af739_t1_e2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/af739_t1_e2_%j.err
#SBATCH --export=ALL
...
/mnt/aiongpfs/projects/eint/envs/.micromamba/envs/insider/bin/python3 scripts/run_block3_benchmark_shard.py \
    ...
    --preset full --output-dir runs/benchmarks/block3_phase9_fair/task1_outcome/autofit/core_edgar_seed2 --seed 42
