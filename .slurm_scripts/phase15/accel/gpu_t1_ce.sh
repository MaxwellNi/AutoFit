...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/gpu_ac_t1_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/gpu_ac_t1_ce_%j.err
#SBATCH --export=ALL
