...
#SBATCH --output=/work/projects/eint/logs/phase15/hp_ac_t1_e2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/hp_ac_t1_e2_%j.err
#SBATCH --export=ALL
