...
#SBATCH --output=/work/projects/eint/logs/phase15/hp_ac_t3_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/hp_ac_t3_ct_%j.err
#SBATCH --export=ALL
