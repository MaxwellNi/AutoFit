...
#SBATCH --output=/work/projects/eint/logs/phase15/hp_ac_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/hp_ac_t2_ce_%j.err
#SBATCH --export=ALL
