...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/l40_ac_t2_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/l40_ac_t2_co_%j.err
#SBATCH --export=ALL
