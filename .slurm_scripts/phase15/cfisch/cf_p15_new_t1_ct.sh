#!/usr/bin/env bash
#SBATCH --job-name=cf_p15_new_t1_ct
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/cf_p15_new_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/cf_p15_new_t1_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: tslib_sota | Abl: core_text | Models: CARD,CFPT,DeformableTST,DUET,FiLM,FilterTS,FreTS,Fredformer,MICN,ModernTCN,NonstationaryTransformer,PDF,PIR,PathFormer,SCINet,SEMPO,SRSNet,SegRNN,SparseTSF,TimeBridge,TimePerceiver,TimeRecipe,xPatch"
