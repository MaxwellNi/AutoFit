#!/usr/bin/env bash
#SBATCH --job-name=cf_p15_new_t2_fu
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/cf_p15_new_t2_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/cf_p15_new_t2_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Cat: tslib_sota | Abl: full | Models: CARD,CFPT,DeformableTST,DUET,FiLM,FilterTS,FreTS,Fredformer,MICN,ModernTCN,NonstationaryTransformer,PDF,PIR,PathFormer,SCINet,SEMPO,SRSNet,SegRNN,SparseTSF,TimeBridge,TimePerceiver,TimeRecipe,xPatch"
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    --task task2_forecast --category tslib_sota --ablation full \
    --preset full --output-dir runs/benchmarks/block3_phase9_fair/task2_forecast/tslib_sota/full --seed 42 \
