#!/usr/bin/env bash
#SBATCH --job-name=hp_fix11_t1_co
#SBATCH --account=npin
...
#SBATCH --output=/work/projects/eint/logs/phase15/hp_fix11_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/hp_fix11_t1_co_%j.err
#SBATCH --export=ALL
