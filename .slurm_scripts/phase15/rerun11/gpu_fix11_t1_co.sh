#!/usr/bin/env bash
#SBATCH --job-name=gpu_fix11_t1_co
#SBATCH --account=npin
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/gpu_fix11_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/gpu_fix11_t1_co_%j.err
#SBATCH --export=ALL
...
echo "Phase 15 Fix11 (GPU) | Job ${SLURM_JOB_ID} on $(hostname)"
