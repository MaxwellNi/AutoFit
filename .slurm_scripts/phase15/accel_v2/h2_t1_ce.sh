...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/h2_ac_t1_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/h2_ac_t1_ce_%j.err
#SBATCH --export=ALL
