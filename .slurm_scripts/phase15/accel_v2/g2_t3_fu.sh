...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/g2_ac_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/g2_ac_t3_fu_%j.err
#SBATCH --export=ALL
