...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/l2_ac_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/l2_ac_t2_ct_%j.err
#SBATCH --export=ALL
