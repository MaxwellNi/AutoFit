...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/l2_ac_t2_e2_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/l2_ac_t2_e2_%j.err
#SBATCH --export=ALL
