...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/mtcn_t3_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/mtcn_t3_ce_%j.err
#SBATCH --export=ALL
