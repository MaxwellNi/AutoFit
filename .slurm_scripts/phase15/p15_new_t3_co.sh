...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase15/p15_new_t3_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase15/p15_new_t3_co_%j.err
#SBATCH --export=ALL
...
echo "Task: task3_risk_adjust | Cat: tslib_sota | Abl: core_only | Models: CARD,CFPT,DeformableTST,DUET,FiLM,FilterTS,FreTS,Fredformer,MICN,ModernTCN,NonstationaryTransformer,PDF,PIR,PathFormer,SCINet,SEMPO,SRSNet,SegRNN,SparseTSF,TimeBridge,TimePerceiver,TimeRecipe,xPatch"
