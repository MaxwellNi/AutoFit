...
#SBATCH --output=/work/projects/eint/logs/phase7_v731/v731_t1_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v731/v731_t1_ce_%j.err
#SBATCH --export=ALL
