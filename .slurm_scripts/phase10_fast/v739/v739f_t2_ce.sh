...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/v739f_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/v739f_t2_ce_%j.err
#SBATCH --export=ALL
