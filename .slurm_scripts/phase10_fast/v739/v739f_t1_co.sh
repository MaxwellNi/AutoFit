...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/v739f_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/v739f_t1_co_%j.err
#SBATCH --export=ALL
