#!/usr/bin/env bash
#SBATCH --job-name=cf_v739r_t2_fu
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/cf_v739r_t2_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/cf_v739r_t2_fu_%j.err
#SBATCH --export=ALL
