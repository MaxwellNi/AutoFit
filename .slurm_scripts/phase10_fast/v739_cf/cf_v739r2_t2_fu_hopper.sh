#!/usr/bin/env bash
#SBATCH --job-name=cf_v739r2_t2fh
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/cf_v739r2_t2fh_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/cf_v739r2_t2fh_%j.err
#SBATCH --export=ALL
...
echo "V739 cfisch RETRY2 (500G) | Job ${SLURM_JOB_ID} on $(hostname) | hopper/besteffort"
