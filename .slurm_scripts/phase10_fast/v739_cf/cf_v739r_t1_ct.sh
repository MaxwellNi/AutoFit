#!/usr/bin/env bash
#SBATCH --job-name=cf_v739r_t1_ct
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/cf_v739r_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/cf_v739r_t1_ct_%j.err
#SBATCH --export=ALL
