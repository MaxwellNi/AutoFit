...
echo "Results: $(wc -c < runs/benchmarks/block3_20260203_225620_iris_full/task1_outcome/autofit/core_edgar/metrics.json 2>/dev/null || echo 0) bytes"
echo "============================================================"
