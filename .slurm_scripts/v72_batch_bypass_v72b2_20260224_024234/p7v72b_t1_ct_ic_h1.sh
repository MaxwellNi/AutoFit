#!/usr/bin/env bash
#SBATCH --job-name=p7v72b_t1_ct_ic_h1
...
#SBATCH --output=/work/projects/eint/logs/v72_batch_bypass_v72b2_20260224_024234/p7v72b_t1_ct_ic_h1_%j.out
#SBATCH --error=/work/projects/eint/logs/v72_batch_bypass_v72b2_20260224_024234/p7v72b_t1_ct_ic_h1_%j.err
#SBATCH --export=ALL
...
echo "Task=task1_outcome Ablation=core_text Target=investors_count Horizon=1"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py   --task task1_outcome   --category autofit   --ablation core_text   --models AutoFitV72   --target-filter investors_count   --horizons-filter 1   --preset full   --output-dir runs/benchmarks/block3_20260203_225620_phase7_v72_completion/task1_outcome/autofit/core_text/investors_count/h1   --seed 42   --no-verify-first   --enable-global-dedup   --global-dedup-bench-glob block3_20260203_225620*
