...
/mnt/aiongpfs/projects/eint/envs/.micromamba/envs/insider/bin/python3 scripts/run_block3_benchmark_shard.py \
  ...
  --models ElasTST \
  --model-kwargs-json '{"ElasTST":{"input_size":60,"l_patch_size":"8_16","hidden_size":64,"d_inner":128,"n_heads":4,"batch_size":32,"max_epochs":5,"patience":2,"max_covariates":8,"max_entities":1000,"max_windows":12000}}' \
  --ablation core_edgar \
  ...
  --max-entities 16 \
  --max-rows 1600 \
  --output-dir runs/benchmarks/block3_phase9_localclear_20260330/elastst_funding_h30
