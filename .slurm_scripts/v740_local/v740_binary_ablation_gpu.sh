...
/mnt/aiongpfs/projects/eint/envs/.micromamba/envs/insider/bin/python3 \
  scripts/run_v740_alpha_component_ablation.py \
  --case-substr binary \
  --skip-existing \
  --output-dir "${RUN_ROOT}/v740_alpha_component_ablation_binary_20260401" \
  --summary-md docs/references/V740_ALPHA_COMPONENT_ABLATION_BINARY_20260401.md