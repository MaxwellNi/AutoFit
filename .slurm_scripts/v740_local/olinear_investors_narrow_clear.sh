...
/mnt/aiongpfs/projects/eint/envs/.micromamba/envs/insider/bin/python3 scripts/run_block3_benchmark_shard.py \
  ...
  --models OLinear \
  --model-kwargs-json '{"OLinear":{"input_size":30,"horizon":14,"max_covariates":8,"d_model":128,"d_ff":128,"e_layers":2,"embed_size":8,"temp_patch_len":6,"temp_stride":6,"batch_size":64,"max_epochs":3,"patience":2,"max_entities":1000,"max_windows":12000}}' \
  --ablation core_edgar \
  ...
  --max-entities 16 \
  --max-rows 1600 \
  --output-dir runs/benchmarks/block3_phase9_localclear_20260330/olinear_investors_h14_ctx30
