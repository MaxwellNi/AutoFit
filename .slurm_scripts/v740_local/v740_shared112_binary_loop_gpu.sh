...
/mnt/aiongpfs/projects/eint/envs/.micromamba/envs/insider/bin/python3 \
  ...
  --skip-existing \
  --output-dir "${RUN_ROOT}/v740_shared112_binary_routed_guard_20260402" \
  --summary-md docs/references/V740_SHARED112_BINARY_ROUTED_GUARD_20260402.md \
