#!/bin/bash
#SBATCH --job-name=v740_112_invh1
#SBATCH --account=npin
...
RUN_ROOT=runs/benchmarks/v740_localclear_20260403
...
/mnt/aiongpfs/projects/eint/envs/.micromamba/envs/insider/bin/python3 \
  ...
  --skip-existing \
  --output-dir "${RUN_ROOT}/v740_shared112_investors_routed_h1_probe_20260403" \
  --summary-md docs/references/V740_SHARED112_INVESTORS_ROUTED_H1_PROBE_20260403.md \
  --surface-json "${RUN_ROOT}/v740_shared112_surface_20260403.json"