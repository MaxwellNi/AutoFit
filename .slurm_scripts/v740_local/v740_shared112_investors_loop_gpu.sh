...
RUN_ROOT=runs/benchmarks/v740_localclear_20260402
...
/mnt/aiongpfs/projects/eint/envs/.micromamba/envs/insider/bin/python3 \
  ...
  --skip-existing \
  --output-dir "${RUN_ROOT}/v740_shared112_investors_routed_loop_20260402" \
  --summary-md docs/references/V740_SHARED112_INVESTORS_ROUTED_LOOP_20260402.md \
  --surface-json "${RUN_ROOT}/v740_shared112_surface_20260402.json"