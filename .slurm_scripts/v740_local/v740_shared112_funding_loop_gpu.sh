...
/mnt/aiongpfs/projects/eint/envs/.micromamba/envs/insider/bin/python3 \
  ...
  --profile quick \
  --skip-existing \
  --output-dir "${RUN_ROOT}/v740_shared112_funding_loop_20260401" \
  --summary-md docs/references/V740_SHARED112_FUNDING_LOOP_20260401.md \
