...
export BLOCK3_TABPFN_CLASSIFIER_MODEL_PATH="${BLOCK3_TABPFN_CLASSIFIER_MODEL_PATH:-/home/users/npin/.cache/huggingface/hub/models--Prior-Labs--tabpfn_2_6/snapshots/6b03c759e5136df1faf03668cd7744f541d5ba31/tabpfn-v2.6-classifier-v2.6_default.ckpt}"
/mnt/aiongpfs/projects/eint/envs/.micromamba/envs/insider/bin/python3 scripts/run_block3_benchmark_shard.py \
  --task task1_outcome \
  --category ml_tabular \
  --models TabPFNClassifier \
  --ablation core_edgar \
  ...
  --max-entities 16 \
  --max-rows 1600 \
  --output-dir runs/benchmarks/block3_phase9_localclear_20260328/tabpfn2_6_classifier
