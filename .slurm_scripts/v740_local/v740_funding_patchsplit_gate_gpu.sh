...
GATE_ROOT="${RUN_ROOT}/v740_funding_patchsplit_gate_20260402"
...
run_variant_suite log_only \
  --disable-funding-source-scaling \
  --disable-funding-anchor

run_variant_suite log_anchor \
  --disable-funding-source-scaling

run_variant_suite log_scale \
  --disable-funding-anchor

run_variant_suite patch1_full

run_variant_suite scale_anchor_no_log \
  --disable-funding-log-domain