#!/bin/bash
#SBATCH --job-name=v740_112_binh1
#SBATCH --account=npin
...
/mnt/aiongpfs/projects/eint/envs/.micromamba/envs/insider/bin/python3 \
  ...
  --skip-existing \
  --output-dir "${RUN_ROOT}/v740_shared112_binary_routed_h1_probe_20260403" \
  --summary-md docs/references/V740_SHARED112_BINARY_ROUTED_H1_PROBE_20260403.md \
