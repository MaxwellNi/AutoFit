#!/usr/bin/env bash
#SBATCH --job-name=p7v72k_t1_ct_ic_h1
...
#SBATCH --output=/work/projects/eint/logs/v72_completion_20260224_022433/p7v72k_t1_ct_ic_h1_%j.out
#SBATCH --error=/work/projects/eint/logs/v72_completion_20260224_022433/p7v72k_t1_ct_ic_h1_%j.err
#SBATCH --export=ALL
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
  ...
  --horizons-filter 1 \
  --preset full \
  --output-dir runs/benchmarks/block3_20260203_225620_phase7_v72_completion/task1_outcome/autofit/core_text/investors_count/h1 \
  --seed 42 \
  --no-verify-first \
  --enable-global-dedup \
