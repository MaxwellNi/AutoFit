#!/usr/bin/env bash
#SBATCH --job-name=p7v72k_t3_fu_ic_h14
...
#SBATCH --output=/work/projects/eint/logs/v72_completion_20260224_022433/p7v72k_t3_fu_ic_h14_%j.out
#SBATCH --error=/work/projects/eint/logs/v72_completion_20260224_022433/p7v72k_t3_fu_ic_h14_%j.err
#SBATCH --export=ALL
...
echo "Task=task3_risk_adjust Ablation=full Target=investors_count Horizon=14"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
  ...
  --horizons-filter 14 \
  --preset full \
  --output-dir runs/benchmarks/block3_20260203_225620_phase7_v72_completion/task3_risk_adjust/autofit/full/investors_count/h14 \
  --seed 42 \
  --no-verify-first \
  --enable-global-dedup \
