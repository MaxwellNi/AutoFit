...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_v735/v735_t1_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v735/v735_t1_ce_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
