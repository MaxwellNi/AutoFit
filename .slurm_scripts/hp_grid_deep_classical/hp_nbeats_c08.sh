...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_deep_classical/hp_nbeats_c08_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_deep_classical/hp_nbeats_c08_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"NBEATS\": {\"batch_size\": 64, \"hidden_size\": 256, \"input_size\": 60, \"learning_rate\": 0.005, \"max_steps\": 200"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/deep_classical/NBEATS/config_08 \
    --seed 42 \
    --no-verify-first \
    --models NBEATS \
    --model-kwargs-json '{"NBEATS": {"batch_size": 64, "hidden_size": 256, "input_size": 60, "learning_rate": 0.005, "max_steps": 2000, "n_blocks": 5}}' &
