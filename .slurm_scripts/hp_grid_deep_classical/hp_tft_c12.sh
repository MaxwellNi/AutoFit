...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_deep_classical/hp_tft_c12_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_deep_classical/hp_tft_c12_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"TFT\": {\"batch_size\": 64, \"dropout\": 0.1, \"hidden_size\": 128, \"input_size\": 90, \"learning_rate\": 0.0005, \""
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/deep_classical/TFT/config_12 \
    --seed 42 \
    --no-verify-first \
    --models TFT \
    --model-kwargs-json '{"TFT": {"batch_size": 64, "dropout": 0.1, "hidden_size": 128, "input_size": 90, "learning_rate": 0.0005, "max_steps": 500, "n_head": 2}}' &
