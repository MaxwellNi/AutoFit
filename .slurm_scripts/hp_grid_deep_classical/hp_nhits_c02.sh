...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_deep_classical/hp_nhits_c02_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_deep_classical/hp_nhits_c02_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"NHITS\": {\"batch_size\": 32, \"hidden_size\": 128, \"input_size\": 30, \"learning_rate\": 0.001, \"max_steps\": 1000"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/deep_classical/NHITS/config_02 \
    --seed 42 \
    --no-verify-first \
    --models NHITS \
    --model-kwargs-json '{"NHITS": {"batch_size": 32, "hidden_size": 128, "input_size": 30, "learning_rate": 0.001, "max_steps": 1000, "n_blocks": 1}}' &
