...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/hp_grid_deep_classical/hp_deepar_c11_%j.out
#SBATCH --error=/work/projects/eint/logs/hp_grid_deep_classical/hp_deepar_c11_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "HP Config: {\"DeepAR\": {\"batch_size\": 64, \"hidden_size\": 256, \"input_size\": 60, \"learning_rate\": 0.005, \"max_steps\": 200"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/hp_grid/deep_classical/DeepAR/config_11 \
    --seed 42 \
    --no-verify-first \
    --models DeepAR \
    --model-kwargs-json '{"DeepAR": {"batch_size": 64, "hidden_size": 256, "input_size": 60, "learning_rate": 0.005, "max_steps": 2000, "n_layers": 1}}' &
