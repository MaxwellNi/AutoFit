...
#SBATCH --output=/work/projects/eint/logs/phase7_autofit_resubmit_20260219_af_timeout_fix/p7r_af2_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_autofit_resubmit_20260219_af_timeout_fix/p7r_af2_t1_fu_%j.err
#SBATCH --export=ALL
