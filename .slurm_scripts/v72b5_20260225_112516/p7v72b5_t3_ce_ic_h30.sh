#!/usr/bin/env bash
#SBATCH --job-name=p7v72b5_t3_ce_ic_h30
...
#SBATCH --output=/work/projects/eint/logs/v72b5_20260225_112516/p7v72b5_t3_ce_ic_h30_%j.out
#SBATCH --error=/work/projects/eint/logs/v72b5_20260225_112516/p7v72b5_t3_ce_ic_h30_%j.err
#SBATCH --export=ALL
set -euo pipefail
...
"4{INSIDER_PY}" scripts/run_block3_benchmark_shard.py   --task task3_risk_adjust   --category autofit   --ablation core_edgar   --models AutoFitV72   --target-filter investors_count   --horizons-filter 30   --preset full   --output-dir runs/benchmarks/block3_20260203_225620_phase7_v72_batch_bypass_v72b5_20260225_112516/task3_risk_adjust/autofit/core_edgar/investors_count/h30   --seed 42   --no-verify-first   --enable-global-dedup   --global-dedup-bench-glob block3_20260203_225620*
