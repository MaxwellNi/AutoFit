#!/usr/bin/env bash
#SBATCH --job-name=p7v72b5_t3_co_ic_h30
...
#SBATCH --output=/work/projects/eint/logs/v72b5_20260225_112516/p7v72b5_t3_co_ic_h30_%j.out
#SBATCH --error=/work/projects/eint/logs/v72b5_20260225_112516/p7v72b5_t3_co_ic_h30_%j.err
#SBATCH --export=ALL
set -euo pipefail
