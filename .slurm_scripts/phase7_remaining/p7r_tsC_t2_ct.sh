...
#SBATCH --output=/work/projects/eint/logs/phase7_remaining/p7r_tsC_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_remaining/p7r_tsC_t2_ct_%j.err
#SBATCH --export=ALL
