...
#SBATCH --output=/work/projects/eint/logs/phase7_remaining/p7r_v73_t2_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_remaining/p7r_v73_t2_co_%j.err
#SBATCH --export=ALL
