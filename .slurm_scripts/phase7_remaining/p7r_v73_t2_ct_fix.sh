...
#SBATCH --output=/work/projects/eint/logs/phase7_remaining/p7r_v73_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_remaining/p7r_v73_t2_ct_%j.err
#SBATCH --export=ALL
...
echo "Python: \$(which python3) | Version: \$(python3 -V)"
...
echo "MEM: 700G (OOM fix for core_text 1.69M rows, was 378G)"
echo "============================================================"
python3 - <<'PY'
import sys, torch
...
echo "Task: task2_forecast | Ablation: core_text | Models: AutoFitV73"
