...
#SBATCH --output=/work/projects/eint/logs/phase7_remaining/p7r_v72_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_remaining/p7r_v72_t1_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Ablation: core_text | Models: AutoFitV72"
