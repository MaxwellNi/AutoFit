...
#SBATCH --output=/work/projects/eint/logs/phase7_v71extreme_lintcheck/p7x_tsr_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v71extreme_lintcheck/p7x_tsr_t2_ce_%j.err
#SBATCH --export=ALL
...
echo "Output: runs/benchmarks/block3_20260203_225620_phase7_v71extreme_lintcheck/pilot/ts_refs/task2_forecast/transformer_sota/core_edgar"
echo "============================================================"
...
CMD=(
    ...
    --ablation core_edgar
    --preset full
    --output-dir runs/benchmarks/block3_20260203_225620_phase7_v71extreme_lintcheck/pilot/ts_refs/task2_forecast/transformer_sota/core_edgar
    --seed 42
    --no-verify-first
)
