...
#SBATCH --output=/work/projects/eint/logs/phase7_v71extreme_lintcheck/p7x_tsr_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v71extreme_lintcheck/p7x_tsr_t1_ct_%j.err
#SBATCH --export=ALL
...
echo "Output: runs/benchmarks/block3_20260203_225620_phase7_v71extreme_lintcheck/pilot/ts_refs/task1_outcome/transformer_sota/core_text"
echo "============================================================"
...
CMD=(
    ...
    --ablation core_text
    --preset full
    --output-dir runs/benchmarks/block3_20260203_225620_phase7_v71extreme_lintcheck/pilot/ts_refs/task1_outcome/transformer_sota/core_text
    --seed 42
    --no-verify-first
)
