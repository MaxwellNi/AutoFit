...
#SBATCH --output=/work/projects/eint/logs/phase8_sat/sat_fmN_t2_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8_sat/sat_fmN_t2_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Cat: foundation | Abl: full | Models: Sundial,TTM,TimerXL,TimesFM2"
