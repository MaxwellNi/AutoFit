...
#SBATCH --output=/work/projects/eint/logs/phase8_sat/sat_fmN_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8_sat/sat_fmN_t1_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: foundation | Abl: core_text | Models: Sundial,TTM,TimerXL,TimesFM2"
