...
#SBATCH --output=/work/projects/eint/logs/phase8_sat/sat_tsB_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8_sat/sat_tsB_t3_fu_%j.err
#SBATCH --export=ALL
