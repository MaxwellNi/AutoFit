#!/usr/bin/env bash
#SBATCH --job-name=s8c_tsT2_t2_ct
...
#SBATCH --output=/work/projects/eint/logs/phase8_snt/s8c_tsT2_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8_snt/s8c_tsT2_t2_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Cat: tslib_sota | Abl: core_text | Models: FreTS,MICN,SegRNN,NonstationaryTransformer,FiLM,SCINet"
