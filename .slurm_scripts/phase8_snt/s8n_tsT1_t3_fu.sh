#!/usr/bin/env bash
#SBATCH --job-name=s8n_tsT1_t3_fu
...
#SBATCH --output=/work/projects/eint/logs/phase8_snt/s8n_tsT1_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8_snt/s8n_tsT1_t3_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task3_risk_adjust | Cat: tslib_sota | Abl: full | Models: TimeFilter,WPMixer,MultiPatchFormer,MSGNet,PAttn,MambaSimple,Crossformer,Koopa"
