...
#SBATCH --output=/work/projects/eint/logs/phase8_snt/s8n_fmN_t2_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8_snt/s8n_fmN_t2_fu_%j.err
#SBATCH --export=ALL
