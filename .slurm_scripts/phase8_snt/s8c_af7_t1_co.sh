...
#SBATCH --output=/work/projects/eint/logs/phase8_snt/s8c_af7_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8_snt/s8c_af7_t1_co_%j.err
#SBATCH --export=ALL
