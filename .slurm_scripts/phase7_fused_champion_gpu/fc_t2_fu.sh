...
#SBATCH --output=/work/projects/eint/logs/phase7_fused_champion/fc_t2_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_fused_champion/fc_t2_fu_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task2_forecast | Ablation: full | Model: FusedChampion"
