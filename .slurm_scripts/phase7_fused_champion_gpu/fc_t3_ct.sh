...
#SBATCH --output=/work/projects/eint/logs/phase7_fused_champion/fc_t3_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_fused_champion/fc_t3_ct_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task3_risk_adjust | Ablation: core_text | Model: FusedChampion"
echo "Output: runs/benchmarks/block3_20260203_225620_phase7/task3_risk_adjust/autofit/core_text"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_text \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/task3_risk_adjust/autofit/core_text \
    --seed 42 \
    --no-verify-first \
