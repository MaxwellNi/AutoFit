...
#SBATCH --output=/work/projects/eint/logs/phase7_fused_champion/fc_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_fused_champion/fc_t2_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Ablation: core_text | Model: FusedChampion"
