...
#SBATCH --gres=gpu:1
#SBATCH --requeue
#SBATCH --output=/work/projects/eint/logs/phase7_v732/v732_t2_ce_be_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v732/v732_t2_ce_be_%j.err
#SBATCH --export=ALL
