#!/usr/bin/env bash
#SBATCH --job-name=p3_tra_t1o_only
...
#SBATCH --output=runs/benchmarks/block3_20260203_225620_iris_phase3/task1_outcome/transformer_sota/core_only/slurm_%j.log
#SBATCH --error=runs/benchmarks/block3_20260203_225620_iris_phase3/task1_outcome/transformer_sota/core_only/slurm_%j.err
#SBATCH --export=ALL
#SBATCH --signal=B:TERM@180

set -e
mkdir -p runs/benchmarks/block3_20260203_225620_iris_phase3/task1_outcome/transformer_sota/core_only
...
$PYTHON scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_iris_phase3/task1_outcome/transformer_sota/core_only \
    --seed 42 \
    --no-verify-first
