#!/usr/bin/env bash
#SBATCH --job-name=p3_aut_t3r_edgar
...
#SBATCH --output=runs/benchmarks/block3_20260203_225620_iris_phase3/task3_risk_adjust/autofit/core_edgar/slurm_%j.log
#SBATCH --error=runs/benchmarks/block3_20260203_225620_iris_phase3/task3_risk_adjust/autofit/core_edgar/slurm_%j.err
#SBATCH --export=ALL
#SBATCH --signal=B:TERM@180

set -e
mkdir -p runs/benchmarks/block3_20260203_225620_iris_phase3/task3_risk_adjust/autofit/core_edgar
...
$PYTHON scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_edgar \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_iris_phase3/task3_risk_adjust/autofit/core_edgar \
    --seed 42 \
    --no-verify-first
