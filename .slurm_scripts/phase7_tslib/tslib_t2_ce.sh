...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_tslib/tslib_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_tslib/tslib_t2_ce_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task2_forecast | Ablation: core_edgar | Models: TimeFilter,WPMixer,MultiPatchFormer,MSGNet,PAttn,MambaSimple,Koopa,FreTS,Crossformer,MICN,SegRNN,NonstationaryTransformer,FiLM,SCINet"
echo "============================================================"
