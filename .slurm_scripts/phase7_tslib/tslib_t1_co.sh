...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_tslib/tslib_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_tslib/tslib_t1_co_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task1_outcome | Ablation: core_only | Models: TimeFilter,WPMixer,MultiPatchFormer,MSGNet,PAttn,MambaSimple,Koopa,FreTS,Crossformer,MICN,SegRNN,NonstationaryTransformer,FiLM,SCINet"
echo "============================================================"
