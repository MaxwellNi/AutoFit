...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_tslib/tslib_t3_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_tslib/tslib_t3_fu_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task3_risk_adjust | Ablation: full | Models: TimeFilter,WPMixer,MultiPatchFormer,MSGNet,PAttn,MambaSimple,Koopa,FreTS,Crossformer,MICN,SegRNN,NonstationaryTransformer,FiLM,SCINet"
echo "============================================================"
