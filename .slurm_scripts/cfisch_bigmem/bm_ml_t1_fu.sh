...
#SBATCH --output=/work/projects/eint/logs/cfisch_bigmem/bm_ml_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/cfisch_bigmem/bm_ml_t1_fu_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "=== bm_ml_t1_fu | Job $SLURM_JOB_ID | $(date -Iseconds) | bigmem ==="
