...
#SBATCH --output=/work/projects/eint/logs/cfisch_bigmem/bm_st_t2_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/cfisch_bigmem/bm_st_t2_fu_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "=== bm_st_t2_fu | Job $SLURM_JOB_ID | $(date -Iseconds) | bigmem ==="
