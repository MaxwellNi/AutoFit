...
#SBATCH --gres=gpu:1
#SBATCH --requeue
#SBATCH --output=/work/projects/eint/logs/phase7_v731/v731_t2_co_be_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v731/v731_t2_co_be_%j.err
#SBATCH --export=ALL
