...
#SBATCH --gres=gpu:1
#SBATCH --requeue
#SBATCH --output=/work/projects/eint/logs/phase7_v731/v731_t1_fu_hm_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v731/v731_t1_fu_hm_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Ablation: full | Model: AutoFitV731 (highmem resub)"
echo "============================================================"
