...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_new_baselines/nb_lstm_t2_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_new_baselines/nb_lstm_t2_fu_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task2_forecast | Ablation: full | Model: LSTM"
echo "============================================================"
