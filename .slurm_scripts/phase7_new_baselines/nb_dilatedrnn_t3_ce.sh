#!/usr/bin/env bash
#SBATCH --job-name=nb_dilatedrnn_t3_ce
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_new_baselines/nb_dilatedrnn_t3_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_new_baselines/nb_dilatedrnn_t3_ce_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "============================================================"
echo "New Baseline: DilatedRNN | Job ${SLURM_JOB_ID}"
echo "$(date -Iseconds) | $(hostname) | GPU: $(nvidia-smi --query-gpu=name --format=csv,noheader 2>/dev/null || echo N/A)"
echo "Task: task3_risk_adjust | Ablation: core_edgar | Model: DilatedRNN"
echo "============================================================"
