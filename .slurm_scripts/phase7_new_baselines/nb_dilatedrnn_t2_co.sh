#!/usr/bin/env bash
#SBATCH --job-name=nb_dilatedrnn_t2_co
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_new_baselines/nb_dilatedrnn_t2_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_new_baselines/nb_dilatedrnn_t2_co_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task2_forecast | Ablation: core_only | Model: DilatedRNN"
echo "============================================================"
...
"${INSIDER_PY}" scripts/run_block3_benchmark_shard.py \
    ...
    --ablation core_only \
    --preset full \
    --output-dir runs/benchmarks/block3_20260203_225620_phase7/task2_forecast/deep_classical/core_only \
    --seed 42 \
    --no-verify-first \
    --models DilatedRNN &
