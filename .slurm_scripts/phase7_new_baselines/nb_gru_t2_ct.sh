...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_new_baselines/nb_gru_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_new_baselines/nb_gru_t2_ct_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task2_forecast | Ablation: core_text | Model: GRU"
echo "============================================================"
