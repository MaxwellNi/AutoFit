#!/usr/bin/env bash
#SBATCH --job-name=nb_dilatedrnn_t1_fu
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase7_new_baselines/nb_dilatedrnn_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_new_baselines/nb_dilatedrnn_t1_fu_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task1_outcome | Ablation: full | Model: DilatedRNN"
echo "============================================================"
