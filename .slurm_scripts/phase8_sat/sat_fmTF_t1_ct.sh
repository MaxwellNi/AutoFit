#!/usr/bin/env bash
#SBATCH --job-name=sat_fmTF_t1_ct
...
#SBATCH --output=/work/projects/eint/logs/phase8_sat/sat_fmTF_t1_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8_sat/sat_fmTF_t1_ct_%j.err
#SBATCH --export=ALL
