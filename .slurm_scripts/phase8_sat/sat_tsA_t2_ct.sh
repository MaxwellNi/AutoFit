...
#SBATCH --output=/work/projects/eint/logs/phase8_sat/sat_tsA_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase8_sat/sat_tsA_t2_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Cat: tslib_sota | Abl: core_text | Models: TimeFilter,WPMixer,MultiPatchFormer,MSGNet,PAttn,MambaSimple,Crossformer"
