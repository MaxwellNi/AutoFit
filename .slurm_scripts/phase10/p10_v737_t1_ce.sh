#!/usr/bin/env bash
#SBATCH --job-name=p10_v737_t1_ce
#SBATCH --account=npin
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/p10_v737_t1_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/p10_v737_t1_ce_%j.err
#SBATCH --export=ALL
