...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/p10r_KP_t3_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/p10r_KP_t3_co_%j.err
#SBATCH --export=ALL
...
echo "Task: task3_risk_adjust | Cat: tslib_sota | Abl: core_only | Models: Koopa"
