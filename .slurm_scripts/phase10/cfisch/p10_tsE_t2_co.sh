...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/p10_tsE_t2_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/p10_tsE_t2_co_%j.err
#SBATCH --export=ALL
...
echo ">>> task2_forecast | core_only | Models: Fredformer,CycleNet,xPatch,FilterTS"
