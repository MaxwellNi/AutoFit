#!/usr/bin/env bash
#SBATCH --job-name=p10r_tsC_t2_ce
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/p10r_tsC_t2_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/p10r_tsC_t2_ce_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Abl: core_edgar | Models: ETSformer,LightTS,Pyraformer,Reformer"
