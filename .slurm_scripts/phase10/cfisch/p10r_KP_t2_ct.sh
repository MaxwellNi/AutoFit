...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/p10r_KP_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/p10r_KP_t2_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Cat: tslib_sota | Abl: core_text | Models: Koopa"
