#!/usr/bin/env bash
#SBATCH --job-name=p10r_tsC_t2_ct
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/p10r_tsC_t2_ct_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/p10r_tsC_t2_ct_%j.err
#SBATCH --export=ALL
...
echo "Task: task2_forecast | Abl: core_text | Models: ETSformer,LightTS,Pyraformer,Reformer"
