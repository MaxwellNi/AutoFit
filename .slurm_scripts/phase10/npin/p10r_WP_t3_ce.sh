...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/p10r_WP_t3_ce_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/p10r_WP_t3_ce_%j.err
#SBATCH --export=ALL
...
echo "Task: task3_risk_adjust | Cat: tslib_sota | Abl: core_edgar | Models: WPMixer"
