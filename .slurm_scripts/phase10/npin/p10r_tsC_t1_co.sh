#!/usr/bin/env bash
#SBATCH --job-name=p10r_tsC_t1_co
#SBATCH --account=npin
...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/p10r_tsC_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/p10r_tsC_t1_co_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Abl: core_only | Models: ETSformer,LightTS,Pyraformer,Reformer"
