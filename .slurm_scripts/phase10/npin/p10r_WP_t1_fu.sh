...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/p10r_WP_t1_fu_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/p10r_WP_t1_fu_%j.err
#SBATCH --export=ALL
...
echo "Task: task1_outcome | Cat: tslib_sota | Abl: full | Models: WPMixer"
