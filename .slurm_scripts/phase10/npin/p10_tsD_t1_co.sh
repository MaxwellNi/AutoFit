...
#SBATCH --gres=gpu:1
#SBATCH --output=/work/projects/eint/logs/phase10/p10_tsD_t1_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase10/p10_tsD_t1_co_%j.err
#SBATCH --export=ALL
...
echo ">>> task1_outcome | core_only | Models: KANAD,FITS,SparseTSF,CATS"
