...
#SBATCH --error=/work/projects/eint/logs/phase7_fused_champion/fc_t2_co_%j.err
#SBATCH --export=ALL
#SBATCH --requeue
...
echo "Task: task2_forecast | Ablation: core_only | Model: FusedChampion"
