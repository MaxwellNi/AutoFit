#!/usr/bin/env bash
#SBATCH --job-name=p7xF_tsr_t3_co
...
#SBATCH --output=/work/projects/eint/logs/phase7_v71extreme_20260214_130737/p7xF_tsr_t3_co_%j.out
#SBATCH --error=/work/projects/eint/logs/phase7_v71extreme_20260214_130737/p7xF_tsr_t3_co_%j.err
#SBATCH --export=ALL
...
echo "Output: runs/benchmarks/block3_20260203_225620_phase7_v71extreme_20260214_130737/full/ts_refs/task3_risk_adjust/transformer_sota/core_only"
echo "============================================================"
...
CMD=(
    ...
    --ablation core_only
    --preset full
    --output-dir runs/benchmarks/block3_20260203_225620_phase7_v71extreme_20260214_130737/full/ts_refs/task3_risk_adjust/transformer_sota/core_only
    --seed 42
    --no-verify-first
)
